        ...
        <CardContent>
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div>
                <p className="text-lg font-light">
                  {isLoading
                    ? "Processing your stock data..."
                    : isDragging
                    ? "Drop your stock data CSV here"
                    : "Drop your stock data CSV here"}
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 font-light mt-1">
                  {isLoading
                    ? "Please wait while we analyze your market data"
                    : "or click to browse your historical stock files"}
                </p>
              </div>
          ...
          <div className="mt-6 space-y-4">
            <div className="text-xs text-gray-500 dark:text-gray-400 font-light text-center space-y-1">
              <p>
                <strong className="font-normal">Expected columns:</strong> Date,
                Price, Open, High, Low, Vol., Change%
              </p>
              <p>
                <strong className="font-normal">File format:</strong> CSV with
                headers, UTF-8 encoding, comma-separated
              </p>
              <p>
                <strong className="font-normal">Sample data:</strong> Check the
                sample-data folder for examples
              </p>
            </div>
